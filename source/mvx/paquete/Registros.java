...
public class Registros {
	...
	public void setAH(int aux) { // modifica solo parte alta
		int nuevovalor;
		nuevovalor = ((this.getRegistro("EAX") & 0xffff00ff) | (aux << 8) & 0x0000ff00);
	...
	public void setAL(int aux) {
		...
		nuevovalor = (this.getRegistro("EAX") & 0xFFFFFF00) | ((aux & 0xFF));
		modificaReg(10, nuevovalor);
	}

	public void setCH(int aux) { // modifica solo parte alta
		int nuevovalor;
		nuevovalor = ((this.getRegistro("ECX") & 0xffff00ff) | (aux << 8) & 0x0000ff00);
	...
	public void setCL(int aux) {
		...
		nuevovalor = (this.getRegistro("ECX") & 0xFFFFFF00) | ((aux & 0xFF));
		modificaReg(12, nuevovalor);
	}

	public void setDH(int aux) { // modifica solo parte alta
		int nuevovalor;
		nuevovalor = ((this.getRegistro("EDX") & 0xffff00ff) | (aux << 8) & 0x0000ff00);
	...
	public void setDL(int aux) {
		...
		nuevovalor = (this.getRegistro("EDX") & 0xFFFFFF00) | ((aux & 0xFF));
		modificaReg(13, nuevovalor);
	}
	...
	public int getAH() {
		return (this.registros.get("EAX") >> 8) & 0xFF;
	}

	public int getAL() {
		return this.registros.get("EAX") & 0xFF;
	}

	public int getCH() {
		return (this.registros.get("ECX") >> 8) & 0xFF;
	}

	public int getCL() {
		return this.registros.get("ECX") & 0xFF;
	}

	public int getDH() {
		return (this.registros.get("EDX") >> 8) & 0xFF;
	}

	public int getDL() {
		return this.registros.get("EDX") & 0xFF;
	}
}
